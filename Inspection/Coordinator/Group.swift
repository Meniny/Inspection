...
@objc public enum Group: Int {
    ...
    internal func inspectionGroup() -> InspectionGroup {
        return InspectionGroup(title: title, group: self)
    }
...
@objc public protocol InspectionGroupProtocol: class {
    var title: String { get }
    var attributes: [Attribute] { get }
}

internal final class InspectionGroup: InspectionGroupProtocol, Hashable, CustomStringConvertible {
    ...
    internal static func ==(lhs: InspectionGroup, rhs: InspectionGroup) -> Bool {
