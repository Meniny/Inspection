...
internal final class InspectionPresentationController: UIPresentationController, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
...
extension UIView {
    ...
    fileprivate var shadow: NSShadow? {
        get {
            ...
            layer.shadowOpacity = Color(system: color)?.rgba.alpha ?? 0.5
        }
    }
