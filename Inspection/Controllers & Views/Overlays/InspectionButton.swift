...
internal final class InspectionButton: UIControl {
    ...
    private let theme: InspectionTheme
    
    internal init(theme: InspectionTheme) {
        self.theme = theme
    ...
    override func layoutSubviews() {
        ...
        _ = UIBezierPath(roundedRect: rect, cornerRadius: size / 2)
