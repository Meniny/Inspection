...
internal final class ReportViewController: InspectionSectionedViewController {
    ...
    internal init(inspection: Inspection, report: Report) {
        self.report = report
        ...
        includeJSONSwitch.onTintColor = inspection.options.theme.editingColor
        includeScreenshotSwitch.onTintColor = inspection.options.theme.editingColor
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.backgroundColor = inspection.options.theme.editingColor
    ...
    @objc private func sendReport(_ sender: UIBarButtonItem) {
        do {
            ...
            if report.includeScreenshot {
                if let screenshot = inspection.screenshot {
