...
extension UIView {
    ...
    /**
     Determines if Inspection should ignore this view when parsing it into a model
     
     - parameter inspection: The Inspection instance
     
     - returns: Returns true if Inspection should ignore this view, false otherwise
     */
    internal override func isVisibleInOverlay(options: InspectionOptions) -> Bool {
